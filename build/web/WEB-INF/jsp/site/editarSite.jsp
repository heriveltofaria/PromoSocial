            ...
            <div class="container">
                <div class="carousel-caption text-primary">
                    ...
                    <form action="salvarEdicao" method="POST"> 
                        <c:forEach var="administradorList" items="${administradorList}">
                            <input value="${administradorList.getSlide1a()}" name="slide1a" type="text" class="form-control">
                            <input value="${administradorList.getSlide1b()}" name="slide1b" type="text" class="form-control input-md">
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <form action="salvarEdicao" method="POST"> 
                        <c:forEach var="administradorList" items="${administradorList}">
                            <input value="${administradorList.getSlide2a()}" name="slide2a" type="text" class="form-control">
                            <input value="${administradorList.getSlide2b()}" name="slide2b" type="text" class="form-control input-md">
                            <button class="btn btn-primary" type="submit">Salvar Edição</button>
                        </c:forEach>
                    </form>
                </div>
