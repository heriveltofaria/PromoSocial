<%-- 
    Document   : cabecalho
    Created on : 13/05/2017, 12:26:51
    Author     : Herivelto
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<c:url value="/resources/img/cras.jpg"/>">
        <title>CRAS PEDRALVA</title>
        <!-- Bootstrap core CSS -->
    ...
    <c:import url="/WEB-INF/jsp/componentes/menuPrincipal.jsp"/>